...
The module wraps the IDirect3D9 and IDirect3DDevice9 interfaces,  
   
 intercepting calls between the application and the real D3D9 backend.  
   
 Application behavior remains unchanged --- the proxy acts as a  
   
